...
def animacion_intro():
    mensaje = "¡Bienvenido a SmartMathEngine!"
...
def resolver_ecuacion_cuadratica(A, B, C):
    ...
    if discriminante < 0:
        ...
        x2 = int((-B - sqrt(discriminante)) / (2*A))
        return f"Las soluciones de la ecuación son: x1 = {x1}, x2 = {x2}"
    ...
    while eleccion != 10:
       ...
       11- Créditos
        ...
        if eleccion == 1:
            ...
            print("")
            print("El profesor Ruben Leal como nuestro tutor guía para el proyecto")
            print("")
