...
def longitud_converter(valor, unidad_origen, unidad_destino):
    ...
    if unidad_origen == unidad_destino:
        return "No se pueden convertir las mismas unidades"
...
def tiempo_converter(valor_tiempo, unidad_origen_tiempo, unidad_destino_tiempo):
    ...
    if unidad_origen_tiempo == unidad_destino_tiempo:
        return "No se pueden convertir las mismas unidades"
...
def masa_converter(valor_masa, unidad_origen_masa, unidad_destino_masa):
    ...
    if unidad_origen_masa == unidad_destino_masa:
        return "No se pueden convertir las mismas unidades"
...
def volumen_converter(valor_volumen, unidad_origen_volumen, unidad_destino_volumen):
    ...
    if unidad_origen_volumen == unidad_destino_volumen:
        return "No se pueden convertir las mismas unidades"
        ...
        if eleccion == 1:
            ...
            while True:
                ...
                if medicion == "metro":
                    ...
                    unidad_origen = input("Ingresa la unidad de origen (metro, decametro, hectometro, kilometro:").lower()
                    unidad_destino = input("Ingresa la unidad de destino (metro, decametro, hectometro, kilometro:").lower()
                    ...
                    unidad_origen_masa = input("Ingresa la unidad de origen (gramo, decagramo, hectogramo, kilogramo:").lower()
                    unidad_destino_masa = input("Ingresa la unidad de destino (gramo, decagramo, hectogramo, kilogramo:").lower()
